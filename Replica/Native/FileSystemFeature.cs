namespace Replica.Native {
	...
	public enum FileSystemFeature : uint {
		...
		/// <summary>The file system preserves the case of file names when it places a name on disk.</summary>
		CasePreservedNames = 2,

		/// <summary>The file system supports Unicode in file names as they appear on disk.</summary>
		UnicodeOnDisk = 4,

		/// <summary>The file system preserves and enforces access control lists (ACL).</summary>
		PersistentACLS = 8,
		...
		/// <summary>The file system supports the Encrypted File System (EFS).</summary>
